:og:description: Django API Generator - Open-Source Library 
:og:image: https://user-images.githubusercontent.com/51070104/197181145-f7458df7-23c3-4c14-bcb1-8e168882a104.jpg
:og:image:alt: A simple tool for generating Secure APIs on top of DRF and Django (open-source library)

Django API Generator
====================

.. title:: Django API Generator - Open-Source Library 
.. meta::
    :description: A simple tool for generating Secure APIs on top of DRF and Django (open-source library)
    :keywords: api generator, dev tools, django generator, django api generator
