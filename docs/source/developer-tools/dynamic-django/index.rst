...
**Dynamic Django** aims to simplify the data processing and consolidation via generated APIs, DataDables, Charts and CLI tools.    

.. image:: https://github.com/user-attachments/assets/4d7513cd-8005-4ba6-94f0-66011f91f6b4
   :alt: Dynamic Django - Dynamic Programming concepts applied in Python/Django
