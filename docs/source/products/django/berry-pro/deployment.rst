Berry PRO Deployment
====================

This page explains how to deploy **Django Berry PRO** on Render, a popular service for developers.   
...
In the end you should have a LIVE deployment identical to the official `Django Berry PRO DEMO <https://django-berry-pro.onrender.com/>`__. 
