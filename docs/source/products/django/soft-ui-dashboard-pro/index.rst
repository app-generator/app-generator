...
Premium Django starter built with Database, DB Tools, API, OAuth, Celery, and React Integration with `Soft Dashboard PRO </product/soft-ui-dashboard/>`__ 
from `Creative-Tim </agency/creative-tim/>`__ using Bootstrap 5 Framework.
