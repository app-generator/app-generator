...
**Open-Source Flask Template** built with a minimum set of features on top of **Black Dashboard** Bootstrap Design. 
...
- `Black Dashboard </docs/templates/bootstrap/black-dashboard.html>`__ Integration 
