...
def stats(request):
    ...
    context = {
        ...
        'last_10_generated_apps': GeneratedApp.objects.order_by('-generated_at')[:5],
        'last_10_downloads': Download.objects.order_by('-downloaded_at')[:5],
        'last_10_sign_ups': User.objects.order_by('-date_joined')[:5]
    }
